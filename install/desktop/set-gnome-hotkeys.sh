...
gsettings set org.gnome.shell.keybindings switch-to-application-1 "['F9']"
gsettings set org.gnome.shell.keybindings switch-to-application-2 "['F10']"
gsettings set org.gnome.shell.keybindings switch-to-application-3 "['F11']"
gsettings set org.gnome.shell.keybindings switch-to-application-4 "['F12']"

# Use super for workspaces
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-1 "['<Alt><Shift>1']"
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-2 "['<Alt><Shift>2']"
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-3 "['<Alt><Shift>3']"
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-4 "['<Alt><Shift>4']"
